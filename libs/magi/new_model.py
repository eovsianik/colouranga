...
class MagiModel(PreTrainedModel):
    ...
    '''# Your existing code for processing detections and associations

    # After processing detections and associations, update the character database
    # Save characters to database
    character_database = load_character_database('character_database.json')  # Load existing database
    # Update character database with new characters
    for image_characters in characters_for_images:
        for character_info in image_characters:
            character_name = character_info["name"]
            character_image = character_info["image"]
            # Add or update character in the database
            if character_name not in character_database:
                character_database[character_name] = [character_image]
            else:
                character_database[character_name].append(character_image)
    save_character_database(character_database, 'character_database.json')  # Save updated database'''
